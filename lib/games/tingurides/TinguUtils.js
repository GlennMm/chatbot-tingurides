...
class Client {
    constructor({ details, loggedIn }) {
        ...
        this.questions = [
            { 
                ...
                index: 0, 
                list: [
                    { key: 'destination', text: 'Can you type the desired destination and enter your phone number.' },
                    { key: 'current_location', text: 'Can type your current location or address.' },
                    { key: 'time', text: 'Enter date and time should we pick you up?' },
                    { key: 'pple_count', text: 'How many people will you be travelling with?' },
            ...
            { 
                ...
                list: [
                    { key: 'destination', text: 'Can you type the desired destination and enter your phone number.' },
                    { key: 'pickup_location', text: 'Can type your current location or address.' },
                    { key: 'time', text: 'Enter the date and time should we pick up the goods to be deliverd?' },
            ...
            { 
                ...
                list: [
                    ...
                    { key: 'time', text: 'Enter the time you would like to book? e.g 08:30 or now' },
                    { key: 'date', text: 'Enter the date you would like to book? e.g 20/02/2022`' },
    ...
    hireDelivery(responses) {
        ...
        const row = JobModel({
          ...
          try {
            row.save()
            return { success: true, message: 'You have created a delivery service job successfully. One of our driver will be in touch with you.' }
          } catch (e) {
    ...
    hireTax(responses) { 
        ...
        const row = JobModel({
          ...
          try {
            row.save()
            return { success: true, message: 'You have created a tax job successfully. One of our driver will be in touch with you.' }
          } catch (e) {
...
function messageWrapper(text) {
    return text+'\n\n' + 'Options:\n*/logout* to log out fron your account.\n*/menu* to view the main menu or quit current operation and view main menu.'
}
